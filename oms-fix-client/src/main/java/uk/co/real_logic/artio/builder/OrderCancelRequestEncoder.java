...
/**
 * Hand-rolled FIX 4.4 OrderCancelRequest (35=F) encoder, following the same
 * generated pattern as {@code NewOrderSingleEncoder} in artio-session-codecs.
 *
 * <p>Fields: ClOrdID(11), OrigClOrdID(41), Symbol(55), Side(54), TransactTime(60).
 *
 * // TODO(POC): replace with Artio codegen-generated encoder from a full FIX 4.4 dictionary.
 */
public class OrderCancelRequestEncoder implements Encoder
{
    // FIX message type 'F' = 70
    public long messageType() { return 70L; }
    ...
    public OrderCancelRequestEncoder side(final char value)
    {
        side    = value;
        hasSide = true;
        return this;
