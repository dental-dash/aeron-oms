...
import com.oms.common.EventService;
 ...
 */
@EventHandler
public class FixOrderEventService extends EventService {
    private static final Log log = LogFactory.getLog(FixOrderEventService.class);

    public FixOrderEventService(CommandStream commands) {
        super(commands);
    }
