...
dependencies {
    ...
    implementation(project(":oms-command-handlers:oms-client-order"))
    implementation(project(":oms-command-handlers:oms-fix-order"))
    implementation(project(":oms-event-handlers:oms-fix-order-event"))
    implementation(project(":oms-event-handlers:oms-read-model-database"))
...
application {
    ...
    applicationDefaultJvmArgs = listOf(
        ...
        "--add-opens=java.base/java.nio=ALL-UNNAMED"   // M5: Undertow XNIO
    )
}
